...
<script>
import colorMixin from "@/assets/js/color";
import editableInput from "./colors/EditableInput.vue";
import saturation from "./colors/Saturation.vue";
import hue from "./colors/Hue.vue";
import alpha from "./colors/Alpha.vue";
import checkboard from "./colors/Checkboard.vue";
